            ...
            RaisedButton(
              ...
              onPressed: () {
                ...
                FlutterBoost.singleton.open(
                    "second", urlParams: <dynamic, dynamic>{"present": true})
                    .then((Map value) {
                  print(
                      "call me when page is finished. did recieve second route result $value");
                });
...
//                Expanded(child: Container()),
              ...
              InkWell(
                ...
                onTap: () =>
                    FlutterBoost.singleton
                        .open(
                        "sample://nativePage", urlParams: <dynamic, dynamic>{
                      "query": {"aaa": "bbb"}
                    }),
              ),
              InkWell(
                  ...
                  onTap: () =>
                      FlutterBoost.singleton.open(
                          "first", urlParams: <dynamic, dynamic>{
                        "query": {
                          "aaa": "bbb"
                        }
                      })
              ...
              InkWell(
                ...
                onTap: () =>
                    FlutterBoost.singleton
                        .open(
                        "sample://flutterPage", urlParams: <dynamic, dynamic>{
                      "query": {"aaa": "bbb"}
                    }),
              ),
              InkWell(
