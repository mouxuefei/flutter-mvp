...
import 'package:flutter_mvp/widgets/ProgressDialog.dart';
import 'package:flutter_mvp/widgets/message_dialog.dart';
import 'package:fluttertoast/fluttertoast.dart';

abstract class ITopView {
  ...
  Color _topBarColor = Colors.white;
  Color _appBarColor = Colors.white;
  Color _appBarContentColor = Colors.black87;
...
abstract class ITopPresenter {
  void attachView(ITopView view);
}

abstract class IView<P extends ITopPresenter> extends ITopView {
  P mPresenter;
}

abstract class IPresenter<V extends ITopView> extends ITopPresenter {
  V mView;
